...
- 当前开发版本：v0.8.4（运营后台 v0.4.17，API v0.4.9）
- 当前生产版本：主站 v0.8.3 · 运营后台 v0.4.16 · API v0.4.9
- 上线状态：生产仍为主站 v0.8.3 · 运营后台 v0.4.16 · API v0.4.9；v0.8.4 / v0.4.17 已完成本地验收，待发布
...
### v0.8.4 / 运营后台 v0.4.17 · 20260811 待上线
...
- 验证：主站与运营后台构建通过；XM/文件分发专项 11 通过 / 1 私有黄金样本跳过；1280×720 与 390×667 本地浏览器使用模拟 `.kgg.flac` 文件复现，完整文案、`KGG` 徽章、隐藏重试和无横向溢出均通过；App 既有 2 条 lint 历史问题未扩大
