...
export const EVENT_LABELS: Record<string, string> = {
  ...
  download_help_entry_view:      '主站 - 拖拽区下方下载帮助入口 - 曝光',
  download_help_entry_click:     '主站 - 拖拽区下方下载帮助入口 - 点击',
  download_help_view:            '主站 - 下载文件位置帮助弹窗 - 曝光',
  download_help_close:           '主站 - 下载文件位置帮助弹窗 - 关闭',
  homepage_announcement_view: '主站 - 首页公告 - 曝光',
  homepage_announcement_action_view: '主站 - 首页公告行动点 - 曝光',
  homepage_announcement_action_click: '主站 - 首页公告行动点 - 点击',
  homepage_announcement_close_view: '主站 - 首页公告关闭按钮 - 曝光',
  homepage_announcement_close_click: '主站 - 首页公告关闭按钮 - 点击',
